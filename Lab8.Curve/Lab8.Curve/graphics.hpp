...
bool line_clip_midpoint(Vector2 &P0, Vector2 &P1, const Vector2 &clip_min,
                        const Vector2 &clip_max);
...
// @TODO: Please implement bezier curve algorithm in cpp
// Also, you can add recursive function or add other functions you need
// Vector2 draw_bezier_recursive(const std::vector<Vector2>& control_points, float t);
void draw_bezier(const std::vector<Vector2>& control_points, std::vector<std::pair<int,int>> &buffer);
