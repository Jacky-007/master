...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance,
  ...
  HR(device->CreateBuffer(&constantBufferDesc, nullptr, &ps_constantBuffer));
  ...
  while (true) {
    ...
    ps_const->dirLight.diffuse = DirectX::XMFLOAT4(0.5f, 0.4f, 0.2f, 1.0f);
    ps_const->dirLight.specular = DirectX::XMFLOAT4(1.0f, 0.9f, 0.5f, 1.0f);
    ...
    ps_const->material.ambient = DirectX::XMFLOAT4(0.5f, 0.5f, 0.5f, 1.0f);
    ps_const->material.diffuse = DirectX::XMFLOAT4(0.5f, 0.5f, 0.5f, 1.0f);
    ps_const->material.specular = DirectX::XMFLOAT4(1.0f, 1.0f, 1.0f, 20.0f);
